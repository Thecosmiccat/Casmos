...
fileprivate class AboutModalView : Control {
    ...
    required init(frame frameRect: NSRect) {
        ...
        let copyrightLayout = TextViewLayout(.initialize(string: "Copyright © 2016 - \(formatter.string(from: Date(timeIntervalSinceReferenceDate: Date.timeIntervalSinceReferenceDate))) CASMOS", color: theme.colors.grayText, font: .normal(.text)), alignment: .center)
